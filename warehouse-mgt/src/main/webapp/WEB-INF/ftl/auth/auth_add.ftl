	...
	<form method="post" action="${DOMAIN}auth/authAddSubmit" class="pageForm required-validate" onsubmit="return validateCallback1(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			...
			<div class="unit">
				...
				<input name="authUrl" class="required1" type="text" size="30" value="" alt="请输入菜单链接"/>
			</div>
			<div class="unit">
			...
			<div class="unit">
				...
				<input name="parentId" class="required1" type="text" size="30" value="" onkeyup="checkNum(this)" alt="请输入父菜单号"/>
			</div>
			<div class="unit">
