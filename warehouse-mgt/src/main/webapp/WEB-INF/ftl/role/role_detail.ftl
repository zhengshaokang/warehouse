 <div class="pageContent">
	<form method="post" action="${DOMAIN}role/roleUpdate/" class="pageForm required-validate" onsubmit="return validateCallback1(this, dialogAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<div class="unit">
				<label style="text-align:right">角色名：</label>
				<input name="realName" class="required" type="text" size="30" value="${roleupdateVo.roleName!''}" class="inputText" placeholder="角色名" readOnly="true"/>
			</div>
			<div class="unit">
