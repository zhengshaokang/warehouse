 ...
 <div class="pageContent">
	<form method="post" action="${DOMAIN}product/productSpecificationssAddSubmit" class="pageForm required-validate" onsubmit="return validateCallback1(this, navTabAjaxDone);">
